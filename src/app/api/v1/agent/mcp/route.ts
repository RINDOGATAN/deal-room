  ...
  try {
    ...
    const tools = [
      ...
      },
      {
        name: "subscribe",
        description:
          "Subscribe to premium skills on a deployment with in-app billing. The hosted pilot (dealroom.todo.law) sells nothing and answers 409: every skill is already available there. Premium skills for your own instance are €60 a year each in the kit, on the todo.law storefront.",
        inputSchema: {
          type: "object",
          properties: {
            skillIds: {
