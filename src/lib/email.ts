      ...
      html: `
        <div style="font-family: sans-serif; max-width: 500px; margin: 0 auto;">
          ...
          <div style="padding: 20px; background: #f5f5f5;">
            <p><strong>${inviterName}</strong> has invited you to negotiate <strong>${dealName}</strong>.</p>
            <p>Click the button below to review and accept the invitation:</p>
            <a href="${inviteUrl}" style="display: inline-block; background: #13e9d1; color: #1c1f37; padding: 12px 24px; text-decoration: none; font-weight: bold; border-radius: 6px; margin: 20px 0;">View Invitation</a>
