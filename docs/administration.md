...
Free for every account on hosted Dealroom; 60 a year each in the kit (in your currency; offline licence). All bilingual EN/ES, all support CALIFORNIA, ENGLAND_WALES, and SPAIN jurisdictions.
...
12 skills for autonomous agent interactions. Free with weekly limits on hosted Dealroom; 60 a year each in the kit (in your currency). All bilingual EN/ES, 3 jurisdictions. Every skill includes Gavel automated arbitration as the default dispute resolution option.
